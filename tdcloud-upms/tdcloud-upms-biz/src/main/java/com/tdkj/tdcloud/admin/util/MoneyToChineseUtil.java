...
/**
 *
 * @ClassName: MoneyToChineseUtil
 * @Description: 金钱大写
 * @author: lgs
 * @date: 2023年4月18日 上午11:30:14
 */
@Component
public class MoneyToChineseUtil {
	...
	public static void main(String[] args) {
		System.out.println(MoneyToChineseUtil.moneyFormat("123123343"));
		System.out.println("---------------"+MoneyToChineseUtil.convert(MoneyToChineseUtil.moneyFormat("123123343")));
	}
