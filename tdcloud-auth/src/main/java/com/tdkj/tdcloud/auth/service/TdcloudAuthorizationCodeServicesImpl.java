package com.tdkj.tdcloud.auth.service;
...
public class TdcloudAuthorizationCodeServicesImpl extends RandomValueAuthorizationCodeServices {

	/**
	 * 授权码模式时: 验证码有效期设置, 默认有效期为5分钟, 单位秒
	 */
	@Value("${tdcloud.authorizationCode.expirationTime:300}")
